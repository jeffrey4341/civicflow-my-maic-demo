...
- [x] Record final portal evidence — [screenshot](../audit/maic_portal_freeze_saved_2026-08-26.png): the application is `Submitted`; the freeze Pitch PDF, Architecture PDF, public video, 386-word summary and reviewed AI disclosure are saved and visible; the Pitch/Architecture/Video hashes were verified by direct readback at `2026-08-26 18:34 MYT`.
