...
- [ ] Track label is stated exactly as **"MAIC Nexus Challenge T5 — Public Services & Smart Cities"** — see [README.md:3](../../README.md) and [architecture.md:3](../architecture/architecture.md)
...
- [ ] Problem statement and PBT (local-council) context are described in [README.md](../../README.md) and [architecture.md](../architecture/architecture.md)
...
- [ ] No real NRIC: rendered only as masked placeholders (`XXXXXX-XX-XXXX`) — see [DATA_CARD.md](../../DATA_CARD.md), [privacy_controls.md:63](../privacy/privacy_controls.md)
...
- [ ] No source code, secrets, or proprietary modules copied from any reference repository — see [source_mapping.md:5](../reference/source_mapping.md)
...
Exact timing source: [demo_script.md](../demo/demo_script.md). Last verified render: [english_video_rebuild_2026-06-15.md](../audit/english_video_rebuild_2026-06-15.md) (180.067 s, 1280×720, H.264 + AAC mono 48 kHz, en-US-AvaMultilingualNeural narration). Narration is **English throughout**; the app UI shows multilingual content.
...
- [ ] **Privacy controls** — [privacy_controls.md](../privacy/privacy_controls.md)
- [ ] **Third-party notices / license** — [THIRD_PARTY_NOTICES.md](../../THIRD_PARTY_NOTICES.md), [LICENSE](../../LICENSE)
- [ ] **Audit trail** demonstrating verification rigor — [docs/audit/](../audit)
- [ ] **This checklist** — [final_submission_checklist.md](final_submission_checklist.md)
