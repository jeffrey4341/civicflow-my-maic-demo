...
const en: Dict = {
  ...
  "status.closed_next": "The case has been closed by a council officer. Any released reply remains available below.",
  "status.new_request": "New request",
  "status.track_another": "Track another case",
  "reply.title": "Reply from the council",
  "reply.from": "From",
  "reply.disclaimer": "System draft, reviewed by an officer. Based on council policy.",
...
const ms: Dict = {
  ...
  "reply.from": "Daripada",
  "reply.disclaimer": "Draf sistem, disemak oleh pegawai. Berdasarkan dasar majlis.",
...
const zh: Dict = {
  ...
  "reply.title": "市议会的回复",
  "reply.from": "来自",
  "reply.disclaimer": "系统草稿，已由官员审核。依据市议会政策。",
  "reply.citations": "依据",
  "reply.back": "返回状态",
...
const ta: Dict = {
  ...
  "reply.disclaimer": "அமைப்பு வரைவு, அலுவலரால் சரிபார்க்கப்பட்டது. நகராட்சிக் கொள்கையை அடிப்படையாகக் கொண்டது.",
